...
<div class="row col-md-12 col-lg-12 col-sm-12 put-left" style="background:white; marige:10px;">
  <form method="post" action="{{ route('semesters.store') }}">
              ...
              <div class="form-group"> 
                <label for="name">Add Semester: </label>
                <input placeholder="Semester name" class="form-control" required name="name" />
              </div>
              <button class="btn-primary" type="submit" value="Submit">Add New Semester</button>    
