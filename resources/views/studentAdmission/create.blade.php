    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                <form action="{{route('studentAdmission.store')}}" enctype="multipart/form-data" method="POST">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            ...
                            <div class="form-group">
                                <input type="text" name="middleName" class="form-control input-lg" placeholder="Middle Name">
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-6 col-md-4">
                    ...
                    <div class="row">
                        <div class="col-xs-8 col-sm-6 col-md-4" >
                            ...
                            <div class="form-group">
                                <input name="birthDate" type="date" class="form-control input-lg" placeholder="Date of Birth">
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            <label for="birthPlace">Birth place</label>
                            <div class="form-group">                                
                                <input type="text" name="birthPlace" id="lastName" class="form-control input-lg" placeholder="Birth place">
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-6 col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            ...
                            <input name="photo" type="file" class="form-control-file input-lg">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            ...
                            <input type="text" name="studentKebele" id="firstName" class="form-control input-lg" placeholder="kebele">
                        </div> 
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            <label for="name">Email</label>
                            <div class="form-group">                                
                            <input type="email" name="email" id="firstName" class="form-control input-lg" placeholder="example@example.com">
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            <label for="name">Phone</label>
                            <div class="form-group">                                
                            <input type="text" name="phone" class="form-control input-lg" placeholder="phone +2519">
                            </div>
                        </div>                                   
                    </div>    
                    ...
                    <div class="row">
                        <div class="col-xs-8 col-sm-8 col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="studentEmergencyFullName" class="form-control input-lg" placeholder="Full Name">
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-8 col-md-6">
                            <label for="studentEmergencyAddress">Address</label>
                            <div class="form-group">
                                <input type="text" name="studentEmergencyAddress" class="form-control input-lg" placeholder="Address">
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            <label for="studentEmergencyRelation">Relation</label>
                            <div class="form-group">
                                <input type="text" name="studentEmergencyRelation" class="form-control input-lg" placeholder="Relation">
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            <label for="studentEmergencyEmail">Email</label>
                            <div class="form-group">
                                <input type="email" name="studentEmergencyEmail" class="form-control input-lg" placeholder="example@example.com">
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-6 col-md-4">
                            <label for="studentEmergencyPhone">Phone Number</label>
                            <div class="form-group">
                                <input type="text" name="studentEmergencyPhone" class="form-control input-lg" placeholder="+251(0)9---">
                            </div>
                        </div>
                    </div>
